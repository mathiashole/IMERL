...
Ejercicio 3: Resumen Numérico
    ...
    Temas: Análisis de distribuciones de datos, comparación de resúmenes numéricos con diagramas de tallo y hojas.

    Correspondencia de conjuntos con el resumen numérico (R):
        El resumen numérico dado tiene un mínimo de 39, un cuartil inferior de 45, una mediana de 49, un cuartil superior de 55 y un máximo de 59.
...
Ejercicio 4: Alturas
    ...
    Temas: Promedio, efectos de un nuevo dato sobre el promedio.

    Altura necesaria para elevar el promedio:
        La altura promedio de las 20 personas es 170 cm. Si se agrega una persona más y se quiere que el nuevo promedio sea 171 cm, utilizamos la fórmula del promedio:
    Nueva altura=(171×21)−(170×20)=191 cm
    Nueva altura=(171×21)−(170×20)=191 cm
