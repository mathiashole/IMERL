...
Calcular la altura promedio de las hijas que son más altas que la media (1.63 m). Las hijas que miden más que la media siguen una distribución normal.

Usamos el Z-score que nos proporciona el desvíos estándar, si este está en un valor específico por encima o por debajo de la media. El valor z nos permite comparar directamente una altura con la distribución normal estándar. 
