...
Sabemos que $Y = -\ln(X)$, esto implica $X = e^{-Y}$ para cada valor de Y podemos calcular el valor de X. Usamos el cambio de variable para transformar la densidad de X en Y.
$$
