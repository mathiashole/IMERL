...
Sabemos que el valor esperado de la derivada de la log-verosimilitud es cero $\mathbb{E}\left[\frac{\partial}{\partial \theta} \ell(\theta, x)\right] = 0$, por lo que $0 = I(\theta)(\mathbb{E}[T(x)] - \theta)$. Entonces si $\mathbb{E}[T(x)] = \theta$, esto muestra que $I(\theta)$ es la información de Fisher.
