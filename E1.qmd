...
El resumen del modelo nos proporciona en el siguiente orden los coeficientes estimados (intercepto y pendiente), el error estándar de los coeficientes, el valor t y el p-valor, $R^2$ ajustado y F-statistic.
