...
## Probar la hipótesis de que la pendiente es nula con un nivel del $95\text{%}$
...
A un nivel de significancia del $95\text{%}$, es decir $(\alpha = 0.05)$. Para probar la hipótesis, se calcula el valor de $p$ correspondiente a $b$​.
...
## Hallar un intervalo de confianza para el valor esperado de $Y$ evaluado en $t = 3$ con un nivel del $95\text{%}$
...
## Hallar un intervalo de confianza para una futura $Y$ evaluado en $t = 3$ con un nivel del $95\text{%}$
