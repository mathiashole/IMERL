...
```{r}
library(dplyr)
library(rpart)       #para construir arboles de decision
library(rpart.plot)  # para graficar arboles de decisión
library(rattle)
...
datos$Atributo <- factor(datos$Atributo) # cambiar a factor
...
```{r}
# Visualización de las contribuciones de las variables
fviz_contrib(pca, choice = "var", axes = 1, top = 5)  # Contribución al CP1
fviz_contrib(pca, choice = "var", axes = 2, top = 5)  # Contribución al CP2
